...
fn get_spell_sprite_dimensions(element: SpellElement, size: SpellSize) -> SpellSpriteDimensions {
	match (element, size) {
		...
		// ////////////////////////////////////////////////
		(SpellElement::Earth, SpellSize::Tiny) => SpellSpriteDimensions(8,8,4,1),
		(SpellElement::Earth, SpellSize::Small) => SpellSpriteDimensions(12,12,4,1),
		(SpellElement::Earth, SpellSize::Normal) => SpellSpriteDimensions(16,16,4,1),
		(SpellElement::Earth, SpellSize::Large) => SpellSpriteDimensions(24,24,4,1),
		// ////////////////////////////////////////////////
		(SpellElement::Air, SpellSize::Tiny) => SpellSpriteDimensions(8,8,4,1),
		(SpellElement::Air, SpellSize::Small) => SpellSpriteDimensions(12,12,4,1),
		(SpellElement::Air, SpellSize::Normal) => SpellSpriteDimensions(16,16,4,1),
		(SpellElement::Air, SpellSize::Large) => SpellSpriteDimensions(24,24,4,1),
		// ////////////////////////////////////////////////
		(SpellElement::Metal, SpellSize::Tiny) => SpellSpriteDimensions(8,8,2,1),
		(SpellElement::Metal, SpellSize::Small) => SpellSpriteDimensions(12,12,2,1),
		(SpellElement::Metal, SpellSize::Normal) => SpellSpriteDimensions(16,16,2,1),
		(SpellElement::Metal, SpellSize::Large) => SpellSpriteDimensions(24,24,6,1),
		// ////////////////////////////////////////////////
		(SpellElement::Plant, SpellSize::Tiny) => SpellSpriteDimensions(10,10,4,1),
		(SpellElement::Plant, SpellSize::Small) => SpellSpriteDimensions(15,15,4,1),
		(SpellElement::Plant, SpellSize::Normal) => SpellSpriteDimensions(20,20,4,1),
		(SpellElement::Plant, SpellSize::Large) => SpellSpriteDimensions(30,30,4,1),
		// ////////////////////////////////////////////////
		(SpellElement::Electric, SpellSize::Tiny) => SpellSpriteDimensions(8,8,4,1),
		(SpellElement::Electric, SpellSize::Small) => SpellSpriteDimensions(12,12,4,1),
		...
		// ////////////////////////////////////////////////
		(SpellElement::Ice, SpellSize::Tiny) => SpellSpriteDimensions(8,8,4,1),
		(SpellElement::Ice, SpellSize::Small) => SpellSpriteDimensions(12,12,4,1),
		(SpellElement::Ice, SpellSize::Normal) => SpellSpriteDimensions(16,16,4,1),
		(SpellElement::Ice, SpellSize::Large) => SpellSpriteDimensions(24,24,4,1),
		// ////////////////////////////////////////////////
		(SpellElement::Light, SpellSize::Tiny) => SpellSpriteDimensions(10,10,4,1),
		(SpellElement::Light, SpellSize::Small) => SpellSpriteDimensions(15,15,4,1),
		(SpellElement::Light, SpellSize::Normal) => SpellSpriteDimensions(20,20,4,1),
		(SpellElement::Light, SpellSize::Large) => SpellSpriteDimensions(30,30,4,1),
	}
}
